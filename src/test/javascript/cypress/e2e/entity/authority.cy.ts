...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '34181e03-c74d-4b68-8f31-8ece693b55f0' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ffa82f84-7611-4cc0-826e-1e700c30fedd');
      cy.get(`[data-cy="name"]`).should('have.value', 'ffa82f84-7611-4cc0-826e-1e700c30fedd');
